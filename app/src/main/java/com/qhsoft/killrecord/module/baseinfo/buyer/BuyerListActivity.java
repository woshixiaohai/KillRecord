package com.qhsoft.killrecord.module.baseinfo.buyer;
...
import com.qhsoft.killrecord.model.remote.service.BuyerService;
...
public class BuyerListActivity extends BaseActivity {
    ...
    protected void onViewCreated(Bundle savedInstanceState) {
        ...
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_save, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CustomerQueryDialog customerQueryDialog = new CustomerQueryDialog(BuyerListActivity.this);
    ...
    private void getList(String fmanageName) {
        requestData(HttpHandler.create(BuyerService.class)
                .getList(UserHelper.getSessionId(), fmanageName, page, MyApp.PAGE_SIZE))
                .subscribe(new TaskObserver<BuyerListBean>() {
                    @Override
                    public void onSuccess(BuyerListBean value) {
    ...
    private class KillListAdapter extends MyListAdapter<BuyerListBean.RowsBean> {
        private List<BuyerListBean.RowsBean> list;

        public KillListAdapter(int load_state, List<BuyerListBean.RowsBean> list) {
        ...
        @Override
        protected void onBindData(BuyerListBean.RowsBean bean, TextView tv) {
        ...
        @Override
        protected void onItemClick(BuyerListBean.RowsBean bean) {
            if(getIntent().getStringExtra("title").startsWith("选择")){
                EventBus.getDefault().post(bean,"getBuyerInfo");
                finish();
            }
