...
public class ProductStoreSelectListActivity extends BaseActivity {
    ...
    protected void onViewCreated(Bundle savedInstanceState) {
        ...
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_query, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CustomerQueryDialog customerQueryDialog = new CustomerQueryDialog(ProductStoreSelectListActivity.this);
        ...
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_add, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post( killListAdapter.getSelectList(),"getProductStoreList");
                finish();
    ...
    private class KillListAdapter extends MyListAdapter<ProductStoreListBean.RowsBean> {
        ...
        @Override
        protected void onCheck(ProductStoreListBean.RowsBean rowsBean, boolean isChecked) {
        ...
        public List<ProductStoreListBean.RowsBean> getSelectList() {
            List<ProductStoreListBean.RowsBean> list_select = new ArrayList<>();
