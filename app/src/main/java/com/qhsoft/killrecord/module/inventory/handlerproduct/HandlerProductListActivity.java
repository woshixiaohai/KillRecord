...
import com.qhsoft.killrecord.module.ledger.harmlesshandle.HarmlessHandleAddActivity;
...
public class HandlerProductListActivity extends BaseActivity {
    ...
    protected void onViewCreated(Bundle savedInstanceState) {
        ...
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_query, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CustomerQueryDialog customerQueryDialog = new CustomerQueryDialog(HandlerProductListActivity.this);
        ...
        mFreeToolbar.setActionText(R.id.toolbar_add, "处理");
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_add, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HandlerProductListActivity.this, HarmlessHandleAddActivity.class);
                intent.putExtra("title","无害化处理新增");
    ...
    private class KillListAdapter extends MyListAdapter<HandlerProductListBean.RowsBean> {
        ...
        @Override
        protected void onItemClick(HandlerProductListBean.RowsBean bean) {
