...
public class ShareBruteListActivity extends BaseActivity {
    ...
    protected void onViewCreated(Bundle savedInstanceState) {
        ...
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_query, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CustomerQueryDialog customerQueryDialog = new CustomerQueryDialog(ShareBruteListActivity.this);
        ...
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_add, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShareBruteListActivity.this, ShareBruteAddActivity.class);
    ...
    private class KillListAdapter extends MyListAdapter<ShareBruteListBean.RowsBean> {
        ...
        @Override
        protected void onItemClick(final ShareBruteListBean.RowsBean bean) {
            DialogFactory.createSheetDialogBuilder().addActionArray(new String[]{"查看","编辑","删除"})
                    ...
                    }).show(ShareBruteListActivity.this);
