...
public class KillRangeSelectOneListActivity extends BaseActivity {
    ...
    protected void onViewCreated(Bundle savedInstanceState) {
        ...
        mFreeToolbar.setOnActionClickListener(R.id.toolbar_query, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CustomerQueryDialog customerQueryDialog = new CustomerQueryDialog(KillRangeSelectOneListActivity.this);
        ...
        mFreeToolbar.setActionViewVisible(R.id.toolbar_add, View.INVISIBLE);
    ...
    private class KillListAdapter extends MyListAdapter<KillRangeListBean.RowsBean> {
        ...
        protected void onItemClick(final KillRangeListBean.RowsBean bean) {
            EventBus.getDefault().post(bean,"getKillRangeInfo");
            finish();
